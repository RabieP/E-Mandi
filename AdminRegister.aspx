<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="AdminRegister.aspx.cs" Inherits="AdminRegister" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
                Admisitrator Id</td>
            <td>
                <asp:TextBox ID="adminid_txt" runat="server" CssClass="input" ReadOnly="True"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
