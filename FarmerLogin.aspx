<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="FarmerLogin.aspx.cs" Inherits="FarmerLogin" %>
    ...
    <tr>
        ...
        <td>
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" 
                NavigateUrl="~/FarmerRegistration.aspx">New Farmer? Register. Its Free</asp:HyperLink>
        </td>
    </tr>
</table>
