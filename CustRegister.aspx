<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="CustRegister.aspx.cs" Inherits="CustRegister" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
                Customer Id</td>
            <td>
                <asp:TextBox ID="custid_txt" runat="server" CssClass="input" ReadOnly="True"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
